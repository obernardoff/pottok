...
project = 'Pottok'
copyright = '2020, Olivia Bernardoff & Nicolas Karasiak'
author = 'Olivia Bernardoff & Nicolas Karasiak'
sphinx_gallery_conf = {
...
html_logo = '../../metadata/logopottok_256.png'
# TODO : logo POTTOK 
...
man_pages = [
    (master_doc, 'pottok', 'Pottok Documentation',
     [author], 1)
]
def setup(app):
